public class GameMaster {
    ...
    public String describe(TravelMethod travelMethod) {
        if (travelMethod.name() == "HORSEBACK" ) {
            return "You're traveling to your destination on horseback.";
        } else if (travelMethod.name() == "WALKING") {
    ...
    public String describe(Character character, Destination destination, TravelMethod travelMethod) {
        return "You're a level " + character.getLevel() + " " + character.getCharacterClass() + " with " + character.getHitPoints() + " hit points. You're traveling to your destination on " + travelMethod.name().toLowerCase() + ". You've arrived at " + destination.getName() + ", which has " + destination.getInhabitants() + " inhabitants.";
    }
